...
document.getElementById('output').innerHTML = unicodeCharacter.concat(u,c,a,aa,ee,C,d,D,r,e,s,n).sort();
    
});

console.log(unicodeCharacter.concat(u,c,a,C,d,D,r,e,s,n,aa,ee));
